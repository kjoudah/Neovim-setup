...
require("lazy").setup({
  ...
  --               ["<C-j>"] = actions.move_selection_next,
  --               ["<C-k>"] = actions.move_selection_previous,
  --               ["<CR>"] = actions.select_default, -- This is the key missing mapping!
  --               ["<C-c>"] = actions.close,
  --               ["<esc>"] = actions.close,
  --               ["<BS>"] = require("yanky.telescope.mapping").delete(),
  --             },
  --             n = {
  --               ["j"] = actions.move_selection_next,
  --               ["k"] = actions.move_selection_previous,
  --               ["<CR>"] = actions.select_default, -- And this one for normal mode
  --               ["q"] = actions.close,
  --               ["<BS>"] = require("yanky.telescope.mapping").delete(),
  --             },
  --           },
  ...
  --     })
  --
  --     -- Load extension after yanky is set up
  --
  ...
  --
  --     { "<A-n>",      "<Plug>(YankyCycleForward)",       mode = "n",           desc = "Cycle forward through yank history" },
  --
  --     { "<A-p>",      "<Plug>(YankyCycleBackward)",      mode = "n",           desc = "Cycle backward through yank history" },
  --
...

  {
    ...
    config = function()
      -- Require statements inside config function to avoid loading issues
          ...
          telescope = {
            ...
            mappings = {
              ...
              i = {
                ...
                ["<CR>"] = yanky_mapping.put("p"),

                ["<C-c>"] = telescope_actions.close,

                ["<esc>"] = telescope_actions.close,

                ["<BS>"] = yanky_mapping.delete(),
